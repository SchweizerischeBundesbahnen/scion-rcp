...
public class ApplicationStartup {
  ...
  @PostContextCreate
  public void postContextCreate(MicrofrontendPlatform microfrontendPlatform, SciIntentClient intentClient) {
        ...
        .host(new HostConfig()
            ...
            .manifest(new Manifest()
                ...
                .capabilities(List.of(
                    new Capability()
                        .type("view")
                        .qualifier(new Qualifier().set("component", "messageClient"))
                        .isPrivate(false)
                        .properties(new Properties()
                            .set("title", "Message Client")
                            .set("heading", "Microfrontend Platform Test Page")
                            .set("eclipseViewId", "ch.sbb.scion.rcp.views.messageClient")),
                    new Capability()
                        .type("view")
                        .qualifier(new Qualifier().set("component", "intentClient"))
                        .isPrivate(false)
                        .properties(new Properties()
                            .set("title", "Intent Client")
                            .set("heading", "Microfrontend Platform Test Page")
                            .set("eclipseViewId", "ch.sbb.scion.rcp.views.intentClient")),
                    new Capability()
                        .type("view")
                        .qualifier(new Qualifier().set("component", "manifestService"))
                        .isPrivate(false)
                        .properties(new Properties()
                            .set("title", "Manifest Service")
                            .set("heading", "Microfrontend Platform Test Page")
                            .set("eclipseViewId", "ch.sbb.scion.rcp.views.manifestService")),
                    new Capability()
                        .type("view")
                        .qualifier(new Qualifier().set("component", "outletRouter"))
                        .isPrivate(false)
                        .properties(new Properties()
                            .set("title", "Outlet Router")
                            .set("heading", "Microfrontend Platform Test Page")
                            .set("eclipseViewId", "ch.sbb.scion.rcp.views.outletRouter")),
                    new Capability()
                        .type("view")
                        .qualifier(new Qualifier().set("component", "sciRouterOutlet"))
                        .properties(new Properties()
                            .set("title", "Router Outlet")
                            .set("heading", "Microfrontend Platform Test Page")
