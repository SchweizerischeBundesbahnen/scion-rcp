    ...
    microfrontendPlatform.startHost(new MicrofrontendPlatformConfig().host(new HostConfig().symbolicName("rcp-host")
        .manifest(new Manifest().name("RCP Application")
            ...
            .capabilities(List.of(
                new Capability().type("view").qualifier(new Qualifier().set("component", "messageClient")).isPrivate(false)
                ...
                new Capability().type("view").qualifier(new Qualifier().set("component", "intentClient")).isPrivate(false)
                ...
                new Capability().type("view").qualifier(new Qualifier().set("component", "manifestService")).isPrivate(false)
                ...
                new Capability().type("view").qualifier(new Qualifier().set("component", "outletRouter")).isPrivate(false)
