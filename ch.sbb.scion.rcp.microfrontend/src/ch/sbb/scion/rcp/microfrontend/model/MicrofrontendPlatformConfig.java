...
public class MicrofrontendPlatformConfig {
  ...
  public MicrofrontendPlatformConfig applications(final List<ApplicationConfig> applications) {
    this.applications = applications;
    return this;
  }

  public MicrofrontendPlatformConfig host(final HostConfig host) {
    this.host = host;
    return this;
  }

  public MicrofrontendPlatformConfig activatorApiDisabled(final Boolean activatorApiDisabled) {
    this.activatorApiDisabled = activatorApiDisabled;
    return this;
  }

  public MicrofrontendPlatformConfig manifestLoadTimeout(final Long manifestLoadTimeout) {
    this.manifestLoadTimeout = manifestLoadTimeout;
    return this;
  }

  public MicrofrontendPlatformConfig activatorLoadTimeout(final Long activatorLoadTimeout) {
    this.activatorLoadTimeout = activatorLoadTimeout;
    return this;
  }

  public MicrofrontendPlatformConfig heartbeatInterval(final Long heartbeatInterval) {
    this.heartbeatInterval = heartbeatInterval;
    return this;
  }

  public MicrofrontendPlatformConfig properties(final Map<String, ?> properties) {
