...
public class HostConfig {
  ...
  public HostConfig symbolicName(final String symbolicName) {
    this.symbolicName = symbolicName;
    return this;
  }

  public HostConfig manifest(final Manifest manifest) {
    this.manifest = manifest;
    return this;
  }

  public HostConfig manifest(final String manifestUrl) {
    this.manifest = manifestUrl;
    return this;
  }

  public HostConfig scopeCheckDisabled(final Boolean scopeCheckDisabled) {
    this.scopeCheckDisabled = scopeCheckDisabled;
    return this;
  }

  public HostConfig intentionCheckDisabled(final Boolean intentionCheckDisabled) {
    this.intentionCheckDisabled = intentionCheckDisabled;
    return this;
  }

  public HostConfig intentionRegisterApiDisabled(final Boolean intentionRegisterApiDisabled) {
    this.intentionRegisterApiDisabled = intentionRegisterApiDisabled;
    return this;
  }

  public HostConfig messageDeliveryTimeout(final Long messageDeliveryTimeout) {
