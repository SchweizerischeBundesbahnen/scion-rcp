...
public class Manifest {
  ...
  public Manifest name(final String name) {
    this.name = name;
    return this;
  }

  public Manifest baseUrl(final String baseUrl) {
    this.baseUrl = baseUrl;
    return this;
  }

  public Manifest intentions(final List<Intention> intentions) {
    this.intentions = intentions;
    return this;
  }

  public Manifest capabilities(final List<Capability> capabilities) {
