...
public class SciMessageClient {
   ...
   * @see https://scion-microfrontend-platform-api.vercel.app/classes/MessageClient.html#request_
   */
  public <T> ISubscription request(String topic, Object body, RequestOptions options, Class<T> clazz,
   ...
   * @see https://scion-microfrontend-platform-api.vercel.app/classes/MessageClient.html#request_
   */
  public <T> ISubscription request(String topic, JsonElement jsonElement, RequestOptions options, Class<T> clazz,
      ISubscriber<TopicMessage<T>> subscriber) {
   ...
   * @see https://scion-microfrontend-platform-api.vercel.app/classes/MessageClient.html#request_
   */
  private <T> ISubscription requestJson(String topic, String json, RequestOptions options, Class<T> clazz,
      ISubscriber<TopicMessage<T>> subscriber) {
    ...
    var requestIIFE = new Script(Resources.readString("js/sci-message-client/request.iife.js"))
        ...
        .replacePlaceholder("options.headers", options.getHeaders(), Flags.ToJson).replacePlaceholder("options.retain", options.isRetain())
  ...
  private CompletableFuture<Void> publishJson(String topic, String json, PublishOptions publishOptions) {
    ...
    new JavaCallback(microfrontendPlatformRcpHost.whenHostBrowser, args -> {
      ...
      new JavaScriptExecutor(microfrontendPlatformRcpHost.hostBrowser, Resources.readString("js/sci-message-client/publish.js"))
          ...
          .replacePlaceholder("message", json).replacePlaceholder("options.headers", options.getHeaders(), Flags.ToJson)
